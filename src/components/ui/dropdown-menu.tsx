...
function DropdownMenu({ ...props }: React.ComponentProps<"div">) {
  return <div data-slot="dropdown-menu" {...props} />
}

function DropdownMenuPortal({ ...props }: React.ComponentProps<"div">) {
  ...
  return (
    ...
    >
      <span className="pointer-events-none absolute left-2 flex size-3.5 items-center justify-center">
        {props["aria-checked"] && <CheckIcon className="size-4" />}
      </span>
      {children}
    </div>
  )
